...
df = pd.read_csv(os.path.join(path, 'CIC-IDS2018.csv'))
...
np.savez_compressed(os.path.join(path, 'Data_CIC_IDS_2018.npz'),
...
print("Variables saved. Filesize: ", os.path.getsize(os.path.join(path, 'Data_CIC_IDS_2018.npz')) / 1024 ** 2, "MB")	
