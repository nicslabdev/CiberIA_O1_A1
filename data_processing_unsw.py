...
def balance_and_split(dataset):
    ...
    for name in class_names:
        ...
        if len(df_class) > 2500:
            df_class = df_class.sample(n=20000, replace=True, random_state=0)
        dfs.append(df_class)
    ...
    return train_test_split(balanced_data.drop('Label', axis=1), balanced_data['Label'], test_size=0.3, random_state=0)
...
features = features.sample(n=140000, random_state=0)
labels = labels.sample(n=140000, random_state=0)
